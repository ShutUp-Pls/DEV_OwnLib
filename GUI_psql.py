...
class GUIpsql(own.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.treeview = own.Treeview(self)
    ...
    def __estado_conectado(self):
        ...
        if self.seleccionar_tabla.opcion and self.seleccionar_tabla.opcion in self.seleccionar_tabla.opciones:
            self.conexion.tabla = self.seleccionar_tabla.opcion
